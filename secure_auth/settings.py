...
PASSWORD_HASHERS = [
    ...
    # (Django utilisera Argon2 en priorité)
]
...
# --- sessions (1h, httpOnly, secure en prod) ---
...
# Optionnel : expiration glissante si tu veux prolonger à chaque requête authentifiée
